...
const Menu = () => {
  ...
  // sorting based on A-Z or Z-A low-high pricing
    ...
    <div>
        ...
        <div className="py-48 flex flex-col  justify-center items-center gap-8">
          ...
          <div className="text-center  space-y-7 px-4">
            ...
            <p className="text-xl text-[#4A4A4A] md:w-4/5 mx-auto">
              ...
              Grrek Salam, Lasagne, Butternut Pumkin, Tokusen Wagyu, Olivas
              Rellenas and more for a moderate cost
            </p>
            <button className="btn bg-green px-8 py-3 font-semibold border-none text-white rounded-full">
              Order Now
            </button>
          </div>
        </div>
      ...
      <div className="section-container">
        ...
        <div className="flex flex-col md:flex-row flex-wrap md:justify-between md:items-center space-y-3 mb-8">
          {/*all category btns */}
          <div className="flex flex-row justify-start md:items-center md:gap-8 gap-4 flex-wrap mt-8">
            <button
              onClick={showAll}
